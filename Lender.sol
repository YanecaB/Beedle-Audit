...
pragma solidity ^0.8.19; //@audit use a specific solidity version
...
contract Lender is Ownable {
    ...
    function getLoanDebt(uint256 loanId) external view returns (uint256 debt) {
        ...
        //(me) we are using >0.8.0 so we are safe from overflow :)
